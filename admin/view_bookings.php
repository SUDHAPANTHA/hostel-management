   ...
   <h1 class="text-center text-light">Bookings</h1>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST["approve"])) {
            ...
            $sql_update_approval = "UPDATE bookings SET approved=1 WHERE id=$booking_id";
            ...
            $sql_update_approval = "UPDATE bookings SET approved=0 WHERE id=$booking_id";
            if ($conn->query($sql_update_approval) === TRUE) {
            ...
            $sql_cancel_booking = "DELETE FROM bookings  WHERE id=$booking_id";
