			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title text-center">Registration </h2>

						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-primary">
									<div class="panel-heading text-center">Fill all Info</div>
									<div class="panel-body">
										<form method="post" action="" class="form-horizontal mx-auto my-4 text-center">
											
										
<div class="form-group">
<label class="col-sm-4 control-label text-center"><h4 style="color: green">Room Related info </h4> </label>
</div>
...
<div class="col-sm-6 col-sm-offset-4 my-2 mx-auto">
