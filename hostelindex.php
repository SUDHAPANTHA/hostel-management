   ...
   <div class="row">
    ...
    <form method="POST" action="">
        ...
        <div class="form-group my-3">
            <a href="forgot-password.php" class="mx-2 fs-6 text-decoration-none text-dark">Forget Password?</a>
    ...
    <div class="container my-5">
        <div class="row mx-3 py-4 my-3">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 py-5 my-3 mx-5 px-4 text-light">
                <h1 class="fw-normal"> Maintaining <br> a respectful homogeneity of  <br>Service and Hospitality</h1>
                <p class="text-justify py-2 fw-light">We Provide the broad range of high quality <br> hospitality services.</p>
