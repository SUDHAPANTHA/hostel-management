...
if ($food_status === "WithFood") {
    ...
    $total_fee += $food_fee;
       ...
       $sql = "INSERT INTO bookings (room_type, name, email, phone,food_status, stay_from, guardian_contact, emergency_contact, guardian_relation, address, total_fee)
       VALUES ('$roomType', '$name', '$email', '$phone','$food_status', '$stay_from', '$guardian_contact', '$emergency_contact', '$guardian_relation', '$address', $total_fee)";
