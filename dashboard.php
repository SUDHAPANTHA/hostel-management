      ...
      <a class="text-decoration-none" href="#">
        <div class="card p-3 shadow bg-purple text-center border-0">
          <div class="card-body">
           ...
           <p class="card-title lead">My Profile</p> 
          <a href="my-profile.php" class="block-anchor panel-footer text-decoration-none text-dark">Full Detail <i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
      </a>
    </div>
    ...
    <div class="col-xs-6 col-sm-6 col-md-3 col-lg-4 p-2">
      <a class="text-decoration-none" href="#">
        <div class="card p-3 shadow bg-purple text-center border-0">
         ...
         <p class="card-title lead">My Room</p> 
         <a href="room-details.php" class="block-anchor panel-footer text-center text-decoration-none text-dark">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
      </a>
    </div>
