      ...
      <a class="text-decoration-none" href="#">
        <div class="card p-3 shadow text-center border-0">
		  ...
		  <i class="fa-solid fa-magnifying-glass fa-2x text-dark" aria-hidden="true"></i>
            <hr />
          <a href="rooms.php" class="text-decoration-none text-dark">  <p class="card-title lead fw-bold">View Room</p> </a>
          </div>
        </div>
      </a>
    </div>
      ...
      <a class="text-decoration-none" href="#">
        <div class="card p-3 shadow bg-purple text-center border-0">
          ...
          <i class="fa-solid fa-users fa-2x text-dark" aria-hidden="true"></i>
            <hr />
           <a href="access-log.php" class="text-decoration-none text-dark fw-bold"> <p class="card-title lead fw-bold">Access Log</p> </a>
          </div>
        </div>
      </a>
    </div>
    ...
    <div class="col-xs-6 col-sm-6 col-md-3 col-lg-4 p-2">
      <a class="text-decoration-none" href="#">
        <div class="card p-3 shadow bg-purple text-center border-0">
          ...
          <a href="view.php" class="text-decoration-none text-dark fw-bold">  <p class="card-title lead fw-bold">Rooms Details</p> </a>
          </div>
        </div>
      </a>
    </div>
